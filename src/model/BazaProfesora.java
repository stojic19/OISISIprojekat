...
public class BazaProfesora {
	...
	private void initProfesore() throws ParseException {
		...
		Profesor p5= new Profesor("Popović","Nikola",new SimpleDateFormat("dd.MM.yyyy").parse("07.08.1978."),"Adresa1","ktel1","mejl1","Adresa k1","brlk1",Titula.BSC,Zvanje.ASISTENT);
		Profesor p6= new Profesor("Jovanović","Jovan",new SimpleDateFormat("dd.MM.yyyy").parse("07.08.1978."),"Adresa2","ktel1","mejl2","Adresa k2","brlk2",Titula.PROFDR,Zvanje.VANREDNIPROFESOR);
		profesori.add(p1);
		profesori.add(p2);
		profesori.add(p3);
		profesori.add(p4);
